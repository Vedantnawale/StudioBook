                    ...
                    <div className="p-6 space-y-2 md:space-y-6 sm:p-8">
                        <form noValidate onSubmit={createNewAccount} className="space-y-4 md:space-y-6">
                            ...
                            <label htmlFor="image_uploads" className='cursor-pointer'>
                                {previewImage ? (
                                    <img className='w-24 h-24 rounded-full m-auto' src={previewImage} alt="Profile" />
                                ) : (
                            ...
                            <div>
                                <label htmlFor="mobileNumber" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Your Mobile Number</label>
                                <input
                                    type="tel"
                                    required
                                    name="mobileNumber"
