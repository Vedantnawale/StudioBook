        ...
        <HomeLayout>
            ...
            >
                <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
                    <h1 className="bg-yellow-500 absolute top-0 w-full text-center py-4 text-2xl font-bold rounded-tl0lg rounded-tr-lg">Purchase Bundle</h1>
                    <div className="px-4 space-y-5 text-center">
                        <p className="text-[17px]">
                            This purchase will allow you to pre book for your chosen studio
                            of {" "} 
                            <span className="text-yellow-500 font-bold">
                                <br />
                               You will notify under 24 hours
                            </span> { " " }
                            All the existing and new studio will be also available
                        </p>
