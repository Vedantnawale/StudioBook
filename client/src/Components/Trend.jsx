...
const Trend = () => {
    return (
        <div>
            <h1 className=' text-4xl madimi-one-regular mt-28 mb-6  ml-3 py-3 text-red-600 text-center'>Trending Offers</h1>
            <div className=' flex justify-center gap-3 mt-2'>
                <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-white shadow-slate-400 dark:border-2">
